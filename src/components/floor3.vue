...
import { GetNewScada,type NewsSadaRow } from '@/api/GetNewScada3F';
import { PostMachineHoursSum,type MachineHoursSumRow } from '@/api/PostMachineHoursSum3F';
  ...
  <div class="sc-top"> 
    ...
    <div class="sc-left">
        ...
        <ul id="sc-menu">
          ...
          <li style="background-color: cadetblue;"><router-link to="/floor3">三楼</router-link></li>         
        </ul>
  </div>  
        ...
        <table class="sc-table1">
          <tbody>
            <tr>
              ...
              <td><div class="sc-MachineIco"><img  src="../assets/zxj.png" style="width: 40px;height: 40px;"/></div></td>
