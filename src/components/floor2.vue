...
const ScadaName="二楼走刀机数字看板"
import { ref, onMounted, onUnmounted, computed } from 'vue'
import { GetLedStatus, type LedStatusRow } from '@/api/GetLed2F';
import { PostSum, type SumRow } from '@/api/GetSum2F';
import { GetMachineInfo,type MachineInfoRow } from '@/api/MachineInfo2F';
import { GetNewScada,type NewsSadaRow } from '@/api/GetNewScada2F';
import { PostMachineHoursSum,type MachineHoursSumRow } from '@/api/PostMachineHoursSum2F';
  ...
  <div class="sc-top"> 
    ...
    <div class="sc-left">
        ...
        <ul id="sc-menu">
          ...
          <li style="background-color: cadetblue;"><router-link to="/floor2">二楼</router-link></li> 
...
.sc-boxMachine .MachineImg{width: 80px;}
.sc-boxMachine .MachineName{width: 80px;background-color: #213547;color: white; border-radius: 5px;font-size: x-large;  text-align: center;}
